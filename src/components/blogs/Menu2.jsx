...
const blogsURL = [
  ...
  { id: 10, url: "/blogs/Lesion-de-Ligamento-cruzado-anterior/" },
  { id: 11, url: "/blogs/Pseudoartrosis-y-Retraso-de-Consolidacion/" },
  { id: 12, url: "/blogs/Fractura-de-tibia-y-Perone/" },
];
