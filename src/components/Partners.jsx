...
function Partners({ URL }) {
  ...
  const partners_en = [
    ...
    {
      image:
        "/El-consejo-mexicano-de-ortopedia-y-traumatologia-reconoce-y-certifica-a-Ricardo-Monge-como-medico-especialista-en-Tijuana.webp",
      hoverLogo: "/cmo.png",
      alt: "The Mexican Council of Orthopedics and Traumatology certifies and evaluates physicians like Ricardo Monge",
    },
    {
      image:
        "/Ricardo-Monge-miembro-de-AANA-fundacion-en-pro-de-la-ensenanza-de-artroscopia-y-cirugia-no-invasivas.webp",
      hoverLogo: "/AANA.png",
      alt: "Dr. Ricardo Monge participates in important foundations specialized in arthroscopy and minimally invasive surgeries",
    },
    {
      image:
        "/Ricardo-Monge-pertenece-a-una-de-las-organizaciones-de-ortopedia-y-traumatologia-mas-grande-de-america-latina.webp",
    ...
    {
      image:
        "/Monge-pertenece-a-la-asociacion-medica-de-especialistas-musculoesqueleticos-mas-grande-del-mundo.webp",
      hoverLogo: "/AAOS.png",
    ...
    {
      image:
        "/El-ortopedista-y-traumatologo-Ricardo-Monge-es-miembro-del-programa-de-ensenanza-de-recostruccion-articular-en-AMECRA.webp",
